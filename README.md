[![Build Backend with Maven](https://github.com/openfilz/document-management/actions/workflows/build-backend.yml/badge.svg)](https://github.com/openfilz/document-management/actions/workflows/build-backend.yml)
