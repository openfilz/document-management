...
public class SecurityIntegrationIT extends TestContainersBaseConfig {
    ...
    void testDeleteMetadata() {
        ...
        addAuthorization(getDeleteMetadataRequest(uploadResponse), contributorAccessToken).exchange().expectStatus().isNoContent();
    ...
    void testDeleteFile() {
        ...
        addAuthorization(getDeleteFileRequest(uploadResponse), contributorAccessToken).exchange().expectStatus().isNoContent();
    ...
    void testDeleteFolder() {
        ...
        addAuthorization(getDeleteFolderRequest(folder), contributorAccessToken).exchange().expectStatus().isNoContent();
